...
const Result = () => {
  const [image, setImage] = useState(assets.main_img);
    ...
    >
      <div>
        <div className="relative">
          <img src={image} alt="robot painting" className="max-w-lg rounded" />
          <span
      ...
      {!isImageLoaded ? (
        ...
        <div className="flex gap-3 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full">
          <p
